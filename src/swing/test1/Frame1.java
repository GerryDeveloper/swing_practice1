...
public class Frame1 {
    ...
    private void addPanel() {
        ...
        panel.add(addLeftInnerPanel(frame.getWidth(), frame.getHeight()), BorderLayout.WEST);
        panel.add(addRightInnerPanel(frame.getWidth(), frame.getHeight()), BorderLayout.EAST);
    ...
    private JPanel addLeftInnerPanel(int w1, int h1) {
        ...
        leftPanel.setPreferredSize( new Dimension((w1/2), h1));
    ...
    private JPanel addRightInnerPanel(int w1, int h1) {
        ...
        rightPanel.setPreferredSize( new Dimension(w1/2, h1));
